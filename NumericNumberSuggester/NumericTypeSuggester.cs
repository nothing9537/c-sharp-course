...
internal class NumericTypeSuggester
{
    ...
    public static string GetName(BigInteger minValue, BigInteger maxValue, bool integralOnly, bool mustBePrecise)
    {
        return integralOnly
            ...
            : GetFloaintPointNumberName(minValue, maxValue, mustBePrecise);
    }

    private static string GetFloaintPointNumberName(BigInteger minValue, BigInteger maxValue, bool mustBePrecise)
    {
